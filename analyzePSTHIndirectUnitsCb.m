%% THIS SCRIPT ANALYSIS PSTHs FOR INDIRECT UNITS IN CEREBELLUM 
%  Author - Aamir Abbasi
%  -----------------------------------------------------------------------
%% Analyze PSTHs of indirect units in Cb (Around task-start)
clear;clc;close all;
disp('running');
...
%% Analyze PSTHs of indirect units in Cb (Around reward)
clear;clc;close all;
disp('running');
rootpath = 'Z:\Aamir\BMI\';
...
%% EXAMPLE Cb UNIT PSTH AROUND TASK-START
clear; clc; close all;
path = 'Z:\Aamir\BMI\I076\Data\I076-201205-112030\';
load([path,'Indirect_Units_Cb.mat']);
...
%% EXAMPLE Cb UNIT PSTH AROUND REWARD
clear; clc; close all;
path = 'Z:\Aamir\BMI\I076\Data\I076-201202-112106\';
load([path,'Indirect_Units_Reward_Cb.mat']);
