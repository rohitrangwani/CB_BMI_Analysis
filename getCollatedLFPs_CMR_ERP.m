...
clear;clc;close all;
disp('running...');
rootpath = 'Z:\Rohit\BMI_Data\I154\Data\';

bmiBlocks = dir(rootpath);

for i=[8,14,15,16,18,19]%8:length(bmiBlocks)
  ...
  % Save
  save([rootpath, bmiBlocks(i).name,'\','Collated_LFP_CMR_ERP.mat'],...
    'trial_data1_cmr','trial_data1_erp','trial_data2_cmr','trial_data2_erp',...
